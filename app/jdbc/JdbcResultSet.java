...
/*
 * This file is copied with some small changes from Avatica 1.13
 */
...
class JdbcResultSet extends Meta.MetaResultSet {
    ...
    public static Meta.Signature signature(ResultSetMetaData metaData,
                                              ParameterMetaData parameterMetaData, String sql,
                                              Meta.StatementType statementType) throws  SQLException {
        final Meta.CursorFactory cf = Meta.CursorFactory.LIST;  // because JdbcResultSet#frame
        return new Meta.Signature(columns(metaData), sql, parameters(parameterMetaData),
                null, cf, statementType);
    }

    private static Meta.Signature signature(ResultSetMetaData metaData)
            throws SQLException {
    ...
    public static JdbcResultSet create(String connectionId, int statementId,
        ...
        try {
            Meta.Signature sig = signature(resultSet.getMetaData());
     ...
     * from a result set. */
    public static Meta.Frame frame(StatementInfo info, ResultSet resultSet, long offset,
